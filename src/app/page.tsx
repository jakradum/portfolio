  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-12">
       ...
       <p>Maths is best enjoyed visually. The world's best designers, mathematicians, and programmers have attempted to make maths visual. This is attempt is my own - some of the visual ideas here are my own, and some are borrowed.</p>
